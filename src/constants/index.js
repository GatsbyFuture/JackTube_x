import {
    ...
    FitnessCenter, GraphicEq,
    Home,
    LiveTv, MusicNote,
    OndemandVideo, School, SportsEsports, TheaterComedy
} from '@mui/icons-material';

export const logo = 'https://online.hrplus.uz/assets/images/jacktube_1.jpg';
